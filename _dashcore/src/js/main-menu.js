...
/**
 * Main events used to enable interaction with the menu
 **/
...
const megaAnimatedNavigation = document.querySelector(".st-nav");

if (megaAnimatedNavigation) {
  new MainMenu(".st-nav");
  new MegaAnimatedMenuPopup(".st-nav .st-nav-section.st-nav-mobile");
}
